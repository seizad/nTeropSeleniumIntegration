package com.nterop.tests.selenium.old;
...
public class nteropSeleniumUtils {
...
//		baseUrl = "http://127.0.0.1:8888/WebClient.html?gwt.codesvr=127.0.0.1:9997";
	...
	public String CreateItem() {
		...
		assertFalse(driver
				.findElement(
						By.xpath("//*[@id='gwt-debug-itemform-form']/tbody/tr[3]/td/div/table/tbody/tr/td[1]/table/tbody/tr/td[2]/div/div[2]/select"))
				.isSelected());

		// Validate that Status drop down has "Draft" selected
		assertTrue(driver
				.findElement(
						By.xpath("//*[@id='gwt-debug-itemform-form']/tbody/tr[3]/td/div/table/tbody/tr/td[1]/table/tbody/tr/td[2]/div/div[2]/select/option[3]"))
				.isSelected());
	...
	public String CreateSimpleItem() {
		// Navigate to My Item page
		driver.findElement(By.id("gwt-debug-nav-link-myitems")).click();
	...
	public void SortandReadFirstRowMyItems() {
		...
		ReadValue[0] = driver.findElement(By.xpath("//*[@id='gwt-debug-browse-table']/tbody[1]/tr[1]/td[1]/div"))
				.getText();
		ReadValue[1] = driver.findElement(By.xpath("//*[@id='gwt-debug-browse-table']/tbody[1]/tr[1]/td[3]/div"))
				.getText();
		ReadValue[2] = driver.findElement(By.xpath("//*[@id='gwt-debug-browse-table']/tbody[1]/tr[1]/td[4]/div"))
				.getText();
	...
	public void ShareSettingsUser(boolean EU2, boolean EU1) {
		...
		assertTrue(driver.findElement(By.xpath("//*[@id='gwt-debug-sharing-permission-row-2']/span/input"))
				.isSelected());
		...
		driver.findElement(
				By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[3]/table[1]/tbody/tr/td[5]/div/img"))
				.click();
		driver.findElement(
				By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[3]/table[1]/tbody/tr/td[5]/div/img"))
				.click();
		...
		if (EU2 == true && EU1 == true) {
			...
			driver.findElement(
					By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[2]/table/tbody/tr/td[3]/span/input"))
					.click();
		}
			...
			driver.findElement(By.xpath("//*[@id='gwt-debug-sharing-permission-row-2']/span/input")).click();
			driver.findElement(
					By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[2]/table/tbody/tr/td[4]/span/input"))
					.click();
		}
	...
	public void atLeastOneEditor() {
		driver.findElement(
				By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[1]/table/tbody/tr/td[5]"))
				.click();
		String me = driver
				.findElement(
						By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[1]/table/tbody/tr/td[2]/div/table/tbody/tr/td[1]/div"))
				.getText();
	...
	public void closeEditArea(boolean creatorEditAccess, boolean othersEditAccess) {
		...
		if (creatorEditAccess == true) {
			...
			// The owner doesn't have the "Edit" permission. So "Save" doesn't
			// perform
			driver.findElement(By.id("gwt-debug-itemform-actionbar-button-saveandclose"));
			driver.findElement(By.id("gwt-debug-itemform-actionbar-button-saveandclose")).click();
	...
	public void ShareSettingsGroup(String groupName, boolean EU2, boolean EG) {
		...
		if (EU2 == true && EG == true) {
			driver.findElement(
					By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[1]/table/tbody/tr/td[3]/span/input"))
					.click();
			driver.findElement(
					By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[3]/table/tbody/tr/td[3]/span/input"))
					.click();
		}
			...
			driver.findElement(
					...
					.click();
			driver.findElement(
					By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[3]/table/tbody/tr/td[4]/span/input"))
					.click();
		}
			...
			driver.findElement(
					...
					.click();
			driver.findElement(
					By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[1]/table/tbody/tr/td[4]/span/input"))
					.click();
		}
	...
	public void NotSharingWithAnyone() {
		...
		driver.findElement(By
				.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[1]/table/tbody/tr/td[3]/span/input"));
		driver.findElement(By
				.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[2]/table/tbody/tr/td[5]/div/img"));

		driver.findElement(
				By.xpath("//*[@id='gwt-debug-lightbox-container']/div[2]/div/div[2]/div/div/table/tbody/tr[3]/td/div/div/div/div[2]/table/tbody/tr/td[5]/div"))
				.click();
